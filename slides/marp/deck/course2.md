...
<!--
講者備忘：左邊是牆，右邊是解法，一頁對照完。one-hot 先講白話：整排都是 0，只有這個字自己那一格是 1，等於只回答「是哪個字」，沒有回答「像哪個字」。指著左圖問：這樣編碼，「貓」和「狗」的距離，跟「貓」和「桌子」的距離一樣嗎? 答案是一樣，這就是問題。右圖不寫公式，重點一句：語意 = 學出來的位置，距離近 = 意思近。
...
<!--
講者備忘：先不要講架構，直接玩，這頁有兩拍。第一拍：先只秀第一句，念出
